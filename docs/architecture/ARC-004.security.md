...
|---------|-----------|-------------|----------|---------|----------|
| snapserver | yes | yes | ALL (+DAC,SETUID,SETGID) | PUID:PGID | unconfined* |
| shairport-sync | yes | yes | ALL (+DAC,SETUID,SETGID) | PUID:PGID | unconfined* |
| librespot | yes | yes | ALL (+DAC,SETUID,SETGID) | PUID:PGID | unconfined* |
| mpd | yes | yes | ALL | PUID:PGID | default |
| mympd | yes | yes | ALL | PUID:PGID | default |
| metadata | yes | yes | ALL | PUID:PGID | default |
| tidal-connect | yes | yes | ALL (+DAC) | root** | default |
...
| Tidal runs as root | Proprietary binary | read_only + cap_drop ALL + tmpfs |
