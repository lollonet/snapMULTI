...
flowchart TB
    subgraph "snapMULTI Server"
        ...
        subgraph "Management"
            watchtower[Watchtower Container<br/>Auto-update (opt-in)]
        end
...
*Note: See [USAGE.md](../USAGE.md) for complete port reference including firewall rules.*
