...
1. Receives audio from FIFO pipes (MPD, Spotify, AirPlay)
2. Receives audio from TCP input (port 4953)
3. Encodes to FLAC and distributes to clients
4. Maintains <10ms sync across all clients
5. JSON-RPC API on port 1780 for control
