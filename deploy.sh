...
# Music library path (host directory)
# Mount your music here before starting:
#   sudo mount /dev/sdX1 /media/music
...
EOF
    ...
    info "  MUSIC_PATH=/media/music"
    warn "Mount your music library to /media/music before starting"
fi
